...
export default function SignUpPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Step 1: Create account via Next.js API → Firebase Admin → Firestore
    ...
    <div className="w-full max-w-md">
      <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10">
        ...
        <p className="text-center text-xs text-gray-400 mt-4">
          ...
          <Link href="/terms" className="text-[#D32F2F] hover:underline">Terms</Link>
          {" "}and{" "}
          <Link href="/privacy" className="text-[#D32F2F] hover:underline">Privacy Policy</Link>.
        </p>

        {/* Footer */}
        <p className="text-center text-sm text-gray-500 mt-4">
          Already have an account?{" "}
          <Link href="/sign-in" className="text-[#D32F2F] font-semibold hover:underline">
            Sign in
          </Link>
        </p>
      </div>
